...
namespace DemoHub.Persistence.Models
{
    ...
    public partial class TblDTransaction
    {
        public TblDTransaction()
        {
        ...
        [ForeignKey(nameof(FkTransactionRequest))]
        [InverseProperty(nameof(TblDChesstransactionRequest.TblDTransaction))]
        public virtual TblDChesstransactionRequest FkTransactionRequestNavigation { get; set; }
