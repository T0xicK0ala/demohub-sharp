...
{
    [Table("tbl_R_TotalSecurityBalance", Schema = "chsrep")]
    public partial class TblRTotalSecurityBalance
    {
        [Key]
        [Column("kTotalSecurityBalance")]
        public int KTotalSecurityBalance { get; set; }
        ...
        [Column("dTotalUnitsOnSubRegister", TypeName = "decimal(11, 0)")]
        public decimal? DTotalUnitsOnSubRegister { get; set; }
        [Column("dTotalFundUnitsOnRegister", TypeName = "decimal(12, 6)")]
        public decimal? DTotalFundUnitsOnRegister { get; set; }
        [Required]
        ...
        [InverseProperty(nameof(TblDReportRequest.TblRTotalSecurityBalance))]
